...
class LoginViewModelTest {
    ...
    fun setUp() {
        ...
        viewModel = LoginViewModel(fakeAuth(ApiResult.Success(com.fitpub.android.data.dto.AuthResponse(token = "jwt"))), mock(SessionStore::class.java))
    }
    ...
    private fun fakeAuth(result: ApiResult<com.fitpub.android.data.dto.AuthResponse>) =
