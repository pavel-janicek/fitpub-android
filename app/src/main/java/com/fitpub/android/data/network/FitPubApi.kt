...
import com.fitpub.android.data.dto.FollowResultDto
...
import com.fitpub.android.data.dto.MessageResponse
...
import com.fitpub.android.data.dto.PageEnvelopeNotificationDto
...
import com.fitpub.android.data.dto.UnreadCountDto
...
import com.fitpub.android.data.dto.VapidKeyResponse
...
// ------------------------------------------------------------------
    ...
    ): Response<List<com.fitpub.android.data.dto.PersonalRecordDto>>

    @GET("api/analytics/achievements")
    suspend fun achievements(): Response<List<com.fitpub.android.data.dto.AchievementDto>>

    @GET("api/analytics/training-load")
    suspend fun trainingLoad(
        @Query("days") days: Int = 90,
    ): Response<List<com.fitpub.android.data.dto.TrainingLoadDto>>
